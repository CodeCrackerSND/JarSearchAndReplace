...
public abstract class AbstractCPInfo extends ClassComponent {
    ...
    public static final short CONSTANT_MethodHandle = 15;  // new added!
    
    public static final short CONSTANT_MethodType = 16;    // new added!
    
    public static final short CONSTANT_InvokeDynamic = 18;  // new added
    
    public transient u1 tag;

    public AbstractCPInfo() {
        this.tag = new u1();
    }
